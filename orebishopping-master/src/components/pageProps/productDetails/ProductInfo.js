...
const ProductInfo = ({ productInfo }) => {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="text-base text-green-600 font-medium">Kuota Tersedia</p>
      <p className="font-medium text-lg">
        <span className="font-normal">Item :</span> {productInfo.color}
      </p>
      <button
        onClick={() =>
          dispatch(
      ...
      <p className="font-normal text-sm">
        <span className="text-base font-medium"> Categories:</span> Travel, Hiking , 
        Tenda, Carrier, Sleeping Bag, Sepatu, Guide. Tags: featured SKU: N/A
      </p>
    </div>
  );
};
